...
export const koreanSearchAliases: Array<[string, string[]]> = [
  ...
  ["ticket pia", ["티켓피아", "피아"]],
  ["e+", ["이플러스", "이 플러스", "eplus"]],
  ["lawson ticket", ["ローチケ", "ローソンチケット", "로치케", "로손", "로손티켓", "로손 티켓", "로치케전자티켓"]],
  ["ticketmaster", ["티켓마스터"]],
  ["ticket board", ["티켓보드", "티켓 보드", "치케보"]],
  ["rakuten ticket", ["楽天チケット", "라쿠텐티켓", "라쿠텐 티켓", "라쿠텐"]],
  ["tixplus", ["티쿠플라", "치케플라", "티켓플러스", "치케프라"]],
  ["livefans", ["라이브팬즈", "라이브팬스", "라이브팬"]],
  ["live nation h.i.p.", ["라이브네이션", "라이브 네이션", "라이브네이션재팬", "라이브 네이션 재팬", "힙재팬"]],
  ["creativeman", ["クリエイティブマン", "크리에이티브맨", "크리에이티브 맨", "크리에이티브맨프로덕션", "크리에이티브맨 프로덕션"]],
  ["도쿄", ["tokyo", "東京", "동경"]],
  ["오사카", ["osaka", "大阪"]],
  ["요코하마", ["yokohama", "横浜"]],
  ["나고야", ["nagoya", "名古屋"]],
